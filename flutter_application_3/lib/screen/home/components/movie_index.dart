...
import 'package:flutter_application_3/screen/details/details_screen.dart';
import 'package:flutter_application_3/screen/home/home_screen.dart';
import '../../../constants/constant.dart';
import '../../../data/data.dart';
import '../../../widget/genres_format.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
              ...
              onTap: () =>
                  Navigator.push(context, PageRouteBuilder(
                    pageBuilder:(context, a1, a2) => DetailScreen(
                      movie: movieData.movieList[widget.index], size: size,
                    )
                  )),
              child: Container(
                width: size.width * .25,
            ...
            GestureDetector(
              onTap: () =>
                  Navigator.push(context, PageRouteBuilder(
                      pageBuilder:(context, a1, a2) => DetailScreen(movie: movieData.movieList[widget.index], size: size)
                  )),
              child: ClipRRect(
