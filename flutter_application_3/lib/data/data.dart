...
import 'package:flutter_application_3/model/cast_model.dart';
    ...
    movieList.add(
      MovieModel(
          ...
          castList: [
            MovieCastModel(
              name: "Willem Dafoe",
              photo: Image.asset("assets/cast/willem.jpg"),
            ),
            MovieCastModel(
              name: "Julianne Nicholson",
              photo: Image.asset("assets/cast/julianne.jpg"),
            ),
            MovieCastModel(
            ...
            MovieCastModel(
              ...
              photo: Image.asset("assets/cast/michael.jpg"),
            )
          ]),
    );
    movieList.add(
      MovieModel(
          ...
          castList: [
            ...
            MovieCastModel(
              name: "Robert De Niro",
              photo: Image.asset("assets/cast/niro.jpg"),
            ),
            MovieCastModel(
              name: "Zazie Beetz",
              photo: Image.asset("assets/cast/zazie.jpg"),
            ),
            MovieCastModel(
              name: "Frances Conroy",
              photo: Image.asset("assets/cast/frances.jpg"),
            ),
          ]),
    );
    movieList.add(
      MovieModel(
          ...
          castList: [
            MovieCastModel(
              name: "Cornelius",
              photo: Image.asset("assets/cast/cornelius.jpg"),
            ),
            MovieCastModel(
              name: "Dr. Zaius",
              photo: Image.asset("assets/cast/zaius.jpg"),
            ),
            MovieCastModel(
              name: "Dr. Zira",
            ...
            MovieCastModel(
              name: "Nova",
              photo: Image.asset("assets/cast/nova.jpg"),
            )
          ]),
    );
  }
